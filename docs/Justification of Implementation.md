...
| Paper's own linear resource-budget formula (`10N`) is measurably wrong-sized | Min. feasible budget fits a super-linear power law $e_{max}\approx 1.369\,N^{1.620}$ (12-point fit, N=10–28); formula is first breached at N=28 (min. feasible=283 > 10×28=280, ratio 1.011×); at N=10 the paper overspends 2–4.8× depending on noise | Roadmap_Derisk_and_Reframe_Results.md |
