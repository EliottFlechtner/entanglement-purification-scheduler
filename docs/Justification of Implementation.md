...
| Paper's own linear resource-budget formula (`10N`) is measurably wrong-sized | Min. feasible budget fits a super-linear power law $e_{max}\approx 0.995\,N^{1.742}$ (pumping-integrated re-run, N=10–20); at N=10 the paper overspends 2–4.8× depending on noise | Roadmap_Derisk_and_Reframe_Results.md |
