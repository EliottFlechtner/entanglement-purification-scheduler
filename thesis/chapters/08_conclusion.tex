...
\TOFIX{add as a bibliography source too?}{The evaluator, the three search tiers of Chapter~\ref{chap:algorithms}, and every experiment script behind the tables and figures in this chapter and its appendix are openly available at \url{https://github.com/EliottFlechtner/entanglement-purification-scheduler}.}