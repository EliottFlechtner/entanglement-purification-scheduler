...
This section collects illustrative figures supporting Chapter~\ref{chap:background}: the elementary Bell-state measurement, a worked example of backbone selection across a full chain, and the circuit-level implementation of the three purification circuits.
