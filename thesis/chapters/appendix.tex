...
\TOFIX{populate once figures are designed}{This section is reserved for illustrative figures supporting Chapter~\ref{chap:relatedwork} (e.g.\ a labeled diagram of the \Gls{rgs}/\Gls{hrgs} structure, or a schematic comparing first-, second-, and third-generation repeater protocols). None of the related-work discussion in Chapter~\ref{chap:relatedwork} currently depends on a figure placed here; add the figure, a short caption, and a forward pointer from the relevant paragraph of Chapter~\ref{chap:relatedwork} to this section once the figures are designed.}
