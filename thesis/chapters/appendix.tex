...
These figures support the runtime and determinism claims of Table~\ref{tab:benchmarks} (Appendix~\ref{app:runtime}), without interrupting the main narrative of Chapter~\ref{chap:results}.
