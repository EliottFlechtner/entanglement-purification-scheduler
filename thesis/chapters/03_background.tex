...
\begin{enumerate}
    \item A resource's span is always a contiguous interval of stations, so that if it spans $(a,b)$ then it also spans every intermediate station $a < i < b$. This is because every backbone operation that extends a span (a \Gls{bsm} or a Swap) connects resources across adjacent stations or at a shared endpoint.
