\begin{table}[ht]
    ...
    \caption[Evaluator-derived fidelity vs.\ $e_d$ (validation table)]{Evaluator-derived fidelity vs.\ $e_d$ for the three canonical schedules of Section~\ref{sec:bg:decoherence}, at $N=10$. Bold rows ($e_d=0.000$ and $e_d=0.010$) are the only two points with a published reference value to compare against (see text).}
