\begin{table}[ht]
    ...
    \caption[Objective-substitution comparison]{Objective-substitution comparison at $N=10$, $e_d=0.01$: five objective definitions with no change to the search algorithm.}
