...
%==============================
% Table of contents: force the same plain page style on every TOC page
% (otherwise only the first page gets \thispagestyle{plain} while any
% overflow page falls back to the fancy header rule, giving inconsistent
% borders across pages), and tighten entry spacing so it fits in 2 pages.
%==============================
\usepackage{etoolbox}
\pretocmd{\tableofcontents}{\cleardoublepage\pagestyle{plain}}{}{}

\usepackage{tocloft}
\setlength{\cftbeforechapskip}{0.8ex}
