...
\TODO{if files of thesis are renamed, also make sure to rename the labels \& references BUT CAREFULLY!}

\TODO{recheck for appendix references}

\TODO{add manually made figures in appendix; ask for directions on where to add any}

\TODO{check if there is a convention to not cite in abstracts}
