...
\begin{minipage}[c]{0.34\textwidth}
    \centering
    \includegraphics[width=0.75\linewidth,keepaspectratio]{images/epita_logo.png}
\end{minipage}
...
\textit{Laboratory} & AQUA~-- Advancing QUantum Architecture, Keio~SFC Campus \\[0.5em]
...
{\small\itshape
  ...
  \textsuperscript{§}Graduate School of Media Design, Keio University, Kanagawa, Japan%
}
